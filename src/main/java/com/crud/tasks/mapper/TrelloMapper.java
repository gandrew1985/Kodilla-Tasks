...
public class TrelloMapper {
    ...
    public List<TrelloBoardDto> mapToBoardsDto(final List<TrelloBoard> trelloBoards) {
        return trelloBoards.stream()
                .map(trelloBoard -> new TrelloBoardDto(trelloBoard.getName(),
                        trelloBoard.getId(), mapToListDto(trelloBoard.getLists())))
                .collect(Collectors.toList());
    }
    ...
    public TrelloCardDto mapToCardDto(final TrelloCard trelloCards) {
        return new TrelloCardDto(trelloCards.getName(),trelloCards.getDescription(),
                trelloCards.getPos(), trelloCards.getListId());
    }
